...
VALID_API_VERSIONS = ["2.4", "2.5", "2.6", "2.7", "2.8", "2.9"]
...
class GraphAPI(object):
    ...
    #     """Published a draft when given its id."""
    #     assert self.access_token, "Write operations require an access token"
    #     return self.request(
    #         "{0}/{1}".format(self.version, draft_id),
    #         post_args={'is_published' : True},
    #         method="POST")

    def update_object(self, object_id, post_args):
        """Updates a particular object by id with the given fields"""
        assert self.access_token, "Write operations require an access token"
        return self.request(
